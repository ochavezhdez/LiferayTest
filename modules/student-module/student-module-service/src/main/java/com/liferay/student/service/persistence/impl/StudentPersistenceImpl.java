...
package com.liferay.student.service.persistence.impl;
...
import com.liferay.student.model.StudentTable;
import com.liferay.student.model.impl.StudentImpl;
import com.liferay.student.model.impl.StudentModelImpl;
...
import com.liferay.student.service.persistence.impl.constants.TESTPersistenceConstants;
...
public class StudentPersistenceImpl
	 ...
	 */
	@Override
	public List<Student> findByFirstName(long groupId, String firstName) {
		return findByFirstName(
			groupId, firstName, QueryUtil.ALL_POS, QueryUtil.ALL_POS, null);
	}
	...
	public List<Student> findByFirstName(
		...
		return findByFirstName(groupId, firstName, start, end, null);
	}
	...
	public List<Student> findByFirstName(
		...
		return findByFirstName(
			groupId, firstName, start, end, orderByComparator, true);
	}
	...
	public List<Student> findByFirstName(
		...
		if (list == null) {
			...
			sb.append(_FINDER_COLUMN_FIRSTNAME_GROUPID_2);
	...
	public Student findByFirstName_First(
		...
		Student student = fetchByFirstName_First(
	...
	public Student fetchByFirstName_First(
		...
		List<Student> list = findByFirstName(
			groupId, firstName, 0, 1, orderByComparator);
	...
	public Student findByFirstName_Last(
		...
		Student student = fetchByFirstName_Last(
			groupId, firstName, orderByComparator);
	...
	public Student fetchByFirstName_Last(
		...
		int count = countByFirstName(groupId, firstName);
		...
		List<Student> list = findByFirstName(
			groupId, firstName, count - 1, count, orderByComparator);
	...
	public Student[] findByFirstName_PrevAndNext(
		...
		try {
			...
			array[0] = getByFirstName_PrevAndNext(
				session, student, groupId, firstName, orderByComparator, true);

			array[1] = student;

			array[2] = getByFirstName_PrevAndNext(
				session, student, groupId, firstName, orderByComparator, false);
	...
	protected Student getByFirstName_PrevAndNext(
		Session session, Student student, long groupId, String firstName,
		OrderByComparator<Student> orderByComparator, boolean previous) {
	...
	public void removeByFirstName(long groupId, String firstName) {
		for (Student student :
				findByFirstName(
					groupId, firstName, QueryUtil.ALL_POS, QueryUtil.ALL_POS,
					null)) {
	...
	private static final String _FINDER_COLUMN_FIRSTNAME_GROUPID_2 =
		"student.groupId = ? AND ";
	...
	public void activate() {
		...
		_finderPathWithPaginationFindByFirstName = new FinderPath(
			...
			new String[] {"groupId", "firstName"}, true);
		...
		_finderPathCountByFirstName = new FinderPath(
			...
			new String[] {Long.class.getName(), String.class.getName()},
			new String[] {"groupId", "firstName"}, false);
