...
public class StudentKeywordQueryContributor implements KeywordQueryContributor {
	...
	public void contribute(String keywords, BooleanQuery booleanQuery,
		...
		queryHelper.addSearchLocalizedTerm(booleanQuery, searchContext, "firstName", false);
		queryHelper.addSearchLocalizedTerm(booleanQuery, searchContext, "lastName", false);
	}
